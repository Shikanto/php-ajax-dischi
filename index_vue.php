...
<head>
    ...
    <!-- <script src="https://cdn.jsdelivr.net/npm/vue@2/dist/vue.js"></script> link vue per development mode-->
    <script src="https://cdn.jsdelivr.net/npm/vue"></script> <!-- link per la produzione e non si vede Devtools Vue -->
